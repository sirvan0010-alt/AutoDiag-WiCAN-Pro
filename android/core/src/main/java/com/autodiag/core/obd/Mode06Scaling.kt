 ...
 *
 * The decoder is deliberately a function: some J1979 scalings are affine,
 * centered/signed, or otherwise not representable as a single multiplier.
 */
 ...
 * Only definitions whose scaling is explicit are registered here.
 */
object Mode06UasRegistry {
    private val definitions = listOf(
        ...
        Mode06UasDefinition(0x20, "Ratio, 0.00390625/bit", { raw -> Mode06ScaledValue(raw * (1.0 / 256.0), "ratio") }, false, "J1979 Appendix E"),
        Mode06UasDefinition(0x27, "Mass air flow, 0.001 kg/h/bit", { raw -> Mode06ScaledValue(raw * 0.001, "kg/h") }, false, "J1979 Appendix E"),
        Mode06UasDefinition(0x2B, "Count, 1 count/bit", { raw -> Mode06ScaledValue(raw.toDouble(), "count") }, false, "J1979 Appendix E"),
        Mode06UasDefinition(0x80, "Signed count, 1 count/bit", { raw -> Mode06ScaledValue(s16(raw).toDouble(), "count") }, true, "J1979 Appendix E"),
