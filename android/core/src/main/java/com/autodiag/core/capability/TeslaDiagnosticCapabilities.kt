...
object TeslaDiagnosticCapabilities {
    /**
     * Complete functional scope requested for the deferred Tesla diagnostics
     * area. No proprietary command bytes or undocumented write sequences are
     * embedded here.
     */
    ...
    fun forDomain(domain: TeslaDiagnosticDomain): List<TeslaDiagnosticFunction> =
